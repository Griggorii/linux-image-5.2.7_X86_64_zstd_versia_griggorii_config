...
проект подобный ядру и увидите как конфиг с поддержкой ядра nvidia будет течь , причину искать некогда найдете так дадите знать какой флаг и почему да и оборудование разное у меня интел.

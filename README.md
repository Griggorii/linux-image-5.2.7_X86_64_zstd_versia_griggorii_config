# linux-image-5.2.7_X86_64_zstd_versia_griggorii_config
...
проект подобный ядру и увидите как конфиг с поддержкой ядра nvidia будет течь , причину искать некогда найдете так дадите знать какой флаг и почему да и оборудование разное у меня интел. Хотите что бы ваша плазма и другие окружения загрузились 
со всей мощи что бы мышка застыла и проверить ядро то берем браузер хромиум , хроме или подобные вбиваем в строку адреса вот это вот chrome://memory-exhaust и жмём интер.

#
# Automatically generated file; DO NOT EDIT.
# Linux/x86 5.2.7 Kernel Configuration
#
